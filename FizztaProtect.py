...
ki = LINETCR.LINE() #Tatsumi
ki.login(qr=True)
ki.loginResult()

kk = LINETCR.LINE() #Bulat
kk.login(qr=True)
kk.loginResult()

kc = LINETCR.LINE() # Akame
kc.login(qr=True)
kc.loginResult()

ks = LINETCR.LINE() #Lubbock
ks.login(qr=True)
ks.loginResult()

ka = LINETCR.LINE() #Sheele
ka.login(qr=True)
ka.loginResult()

kb = LINETCR.LINE() #Mine
kb.login(qr=True)
kb.loginResult()

ko = LINETCR.LINE() #Leone
ko.login(qr=True)
ko.loginResult()

ke = LINETCR.LINE() #Chelsea
ke.login(qr=True)
ke.loginResult()
...
Cmid = kc.getProfile().mid #Akame
Dmid = ks.getProfile().mid #Lubbock
Emid = ka.getProfile().mid #Sheele
Fmid = kb.getProfile().mid #Mine
Gmid = ko.getProfile().mid #Leone
Hmid = ke.getProfile().mid #Chelsea
Imid = ku.getProfile().mid #Susanoo
Smid = satpam.getProfile().mid #Akun Utama
mid1 = k1.getProfile().mid #Backup

Bots=[mid,Amid,Bmid,Cmid,Dmid,Emid,Fmid,Gmid,Hmid,Imid,Smid,mid1,"ua35835da9375cdfc874eaa9b279997da"]
...
≫    [ɴ̷̣̎ɪ̶̚͜ɢ̶̤̄ʜ̶̟́ᴛ̵̩̍ ̶̬͠ʀ̴̲͘ᴀ̸̮̃ɪ̸͙͂ᴅ̴͙́ ̶̲͌ᴛ̷̖̇ᴇ̷͖͘ᴀ̵̆ͅᴍ̴͇̈́]  PROTECT    ≪
...
#--------------------------------
        ...
        if op.type == 26:
            ...
            elif "Najenda kick " in msg.text:
              if msg.from_ in admin:
                midd = msg.text.replace("_second kick ","")
                ki.kickoutFromGroup(msg.to,[midd])
            elif "Tatsumibkick " in msg.text:
              if msg.from_ in admin:
                midd = msg.text.replace("_third kick ","")
                kk.kickoutFromGroup(msg.to,[midd])
            elif "Bulat kick " in msg.text:
              if msg.from_ in admin:
            ...
            elif "Najenda invite " in msg.text:
              if msg.from_ in admin:
                midd = msg.text.replace("sinvite ","")
                ki.findAndAddContactsByMid(midd)
                ki.inviteIntoGroup(msg.to,[midd])
            elif "Tatsumi invite " in msg.text:
              if msg.from_ in admin:
    ...
    #--------------- SC Add Admin ---------
              ...
              if admin == []:
                  ...
                  mc = "||Admin ɴ̷̣̎ɪ̶̚͜ɢ̶̤̄ʜ̶̟́ᴛ̵̩̍ ̶̬͠ʀ̴̲͘ᴀ̸̮̃ɪ̸͙͂ᴅ̴͙́ ̶̲͌ᴛ̷̖̇ᴇ̷͖͘ᴀ̵̆ͅᴍ̴͇̈́||\n=====================\n"
                  for mi_d in admin:
    ...
    #-----------------=Selesai=------------------
              ...
              if msg.from_ in admin:
                if msg.toType == 2:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        random.choice(KAC).sendText(msg.to,"Sudah Dibuka")
                else:
                    if wait["lang"] == "JP":
            ...
            elif msg.text in ["Najend buka qr","Najenda open qr"]:
                if msg.toType == 2:
                    X = cl.getGroup(msg.to)
                    X.preventJoinByTicket = False
                    cl.updateGroup(X)
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"Not for use less than group")
            elif msg.text in ["Tatsumi buka qr","Tatsumi open qr"]:
                if msg.toType == 2:
              ...
              if msg.from_ in admin:
                if msg.toType == 2:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        random.choice(KAC).sendText(msg.to,"Not for use less than group")
            elif msg.text in ["Najenda close qr","Najenda tutup qr"]:
                if msg.toType == 2:
                    X = ki.getGroup(msg.to)
                    X.preventJoinByTicket = True
                    ki.updateGroup(X)
                    ...
                    if wait["lang"] == "JP":
                        ...
                        ki.sendText(msg.to,"Not for use less than group")
            elif msg.text in ["Tatsumi tutup qr","Tatsumi close qr"]:
                if msg.toType == 2:
            ...
            elif msg.text in ["Bulat tutup qr","Bulat close qr"]:
                if msg.toType == 2:
                    X = kc.getGroup(msg.to)
                    X.preventJoinByTicket = True
                    kc.updateGroup(X)
		...
		for ticket_id in n_links:
            ...
            elif "Najenda" == msg.text:
              if msg.from_ in admin:
                ki.sendText(msg.to,mid)
            elif "Tatsumi" == msg.text:
              if msg.from_ in admin:
